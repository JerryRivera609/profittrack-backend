...
public class AuditoriaRepositoryAdapter implements AuditoriaRepository {
    ...
    @Override
    public Auditoria guardar(Auditoria a) {
        return jpa.save(a);
    }

    @Override
    public List<Auditoria> buscarPorEntidad(String entidad, Long entidadId) {
        return jpa.findAllByEntidadAndEntidadId(entidad, entidadId);
    }
}
