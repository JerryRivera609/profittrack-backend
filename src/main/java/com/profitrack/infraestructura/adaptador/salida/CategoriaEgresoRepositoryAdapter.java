...
public class CategoriaEgresoRepositoryAdapter implements CategoriaEgresoRepository {
    ...
    @Override public CategoriaEgreso guardar(CategoriaEgreso c) { return jpa.save(c); }
    @Override public Optional<CategoriaEgreso> buscarPorId(Long id) { return jpa.findById(id); }
    @Override public List<CategoriaEgreso> buscarPorEmpresa(Long empresaId) { return jpa.findAllByEmpresaId(empresaId); }
}
