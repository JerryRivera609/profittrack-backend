...
public class ProyectoEmpleadoRepositoryAdapter implements ProyectoEmpleadoRepository {
    ...
    @Override
    public ProyectoEmpleado guardar(ProyectoEmpleado pe) {
        return jpa.save(pe);
    }

    @Override
    public Optional<ProyectoEmpleado> buscarPorId(Long id) {
        return jpa.findById(id);
    }

    @Override
    public List<ProyectoEmpleado> buscarActivosPorProyecto(Long proyectoId) {
