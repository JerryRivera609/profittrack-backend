...
public class IngresoRepositoryAdapter implements IngresoRepository {
    ...
    @Override
    public Ingreso guardar(Ingreso i) {
        return jpa.save(i);
    }
    ...
    @Override
    public List<Ingreso> buscarActivosPorEmpresa(Long empresaId) {
        return jpa.findAllByEmpresaIdAndActivoTrue(empresaId);
    }

    @Override
    public List<Ingreso> buscarActivosPorProyecto(Long proyectoId) {
