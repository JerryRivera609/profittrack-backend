...
public class ProyectoCostoEmpleadoRepositoryAdapter implements ProyectoCostoEmpleadoRepository {
    ...
    @Override public ProyectoCostoEmpleado guardar(ProyectoCostoEmpleado pce) { return jpa.save(pce); }
    @Override public Optional<ProyectoCostoEmpleado> buscarActivoPorProyectoYEmpleado(Long proyectoId, Long empleadoId) { return jpa.findByProyectoIdAndEmpleadoIdAndFechaFinIsNull(proyectoId, empleadoId); }
}
