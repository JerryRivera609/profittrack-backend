...
public class MetricaProyectoRepositoryAdapter implements MetricaProyectoRepository {
    ...
    @Override public MetricaProyecto guardar(MetricaProyecto m) { return jpa.save(m); }
    @Override public List<MetricaProyecto> buscarPorProyecto(Long proyectoId) { return jpa.findAllByProyectoId(proyectoId); }
}
