...
public class PlanillaRepositoryAdapter implements PlanillaRepository {
    ...
    @Override public Planilla guardar(Planilla p) { return planillaJpa.save(p); }
    @Override public Optional<Planilla> buscarPorId(Long id) { return planillaJpa.findById(id); }
    @Override public List<Planilla> buscarPorEmpresa(Long empresaId) { return planillaJpa.findAllByEmpresaId(empresaId); }
    @Override public DetallePlanilla guardarDetalle(DetallePlanilla d) { return detalleJpa.save(d); }
    @Override public List<DetallePlanilla> buscarDetallesPorPlanilla(Long planillaId) { return detalleJpa.findAllByPlanillaId(planillaId); }
}
