...
public class ReporteService implements ReporteUseCase {
    ...
    public ByteArrayInputStream generarReporteConsolidadoEmpresa(Long empresaId) {
        ...
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            Paragraph subtitle = new Paragraph("PROYECCIÓN (50,000 ITERACIONES POR PROYECTO)", subtitleFont);
